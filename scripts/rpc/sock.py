...
def sock_impl_set_options(client,
    ...
    Args:
        ...
        zerocopy_send_threshold: zero copy send threshold (optional)
    """
    params = {}
    ...
    if zerocopy_send_threshold is not None:
        params['zerocopy_send_threshold'] = zerocopy_send_threshold
